...
class Course(models.Model):
    ...
    image = models.ImageField(upload_to='course/%Y/%m' ,max_length=100, verbose_name=u'封面图')
...
class CourseResource(models.Model):
    ...
    download = models.FileField(upload_to='course/resource/%Y/%m',verbose_name=u'资源类型',max_length=100)
    add_time = models.DateField(default=datetime.now, verbose_name=u'添加时间')
